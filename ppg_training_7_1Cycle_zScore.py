...
Training_Data_One = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Lin_1Cycle_zScore.txt', header = None, delim_whitespace = True)
Training_Data_Two = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Wu_1Cycle_zScore.txt', header = None, delim_whitespace = True)
Training_Data_Three = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Liu_1Cycle_zScore.txt', header = None, delim_whitespace = True)
Training_Data_Four = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Kuo_1Cycle_zScore.txt', header = None, delim_whitespace = True)
Training_Data_Five = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Wang_1Cycle_zScore.txt', header = None, delim_whitespace = True)
Training_Data_Six = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Li_1Cycle_zScore.txt', header = None, delim_whitespace = True)
Training_Data_Seven = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Su_1Cycle_zScore.txt', header = None, delim_whitespace = True)
