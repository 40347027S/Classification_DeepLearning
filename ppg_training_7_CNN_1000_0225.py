...
Training_Data_One = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Lin_PPGFilter.txt', header = None, delim_whitespace = True)
Training_Data_Two = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Wu_PPGFilter.txt', header = None, delim_whitespace = True)
Training_Data_Three = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Liu_PPGFilter.txt', header = None, delim_whitespace = True)
Training_Data_Four = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Kuo_PPGFilter.txt', header = None, delim_whitespace = True)
Training_Data_Five = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Wang_PPGFilter.txt', header = None, delim_whitespace = True)
Training_Data_Six = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Li_PPGFilter.txt', header = None, delim_whitespace = True)
Training_Data_Seven = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\20200225TrainData\Su_PPGFilter.txt', header = None, delim_whitespace = True)
training_data_num=12000
neuron_num=1024
raw_ppg_len=1000
raw_ppg_width=1
