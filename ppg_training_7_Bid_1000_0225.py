...
Training_Data_One = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\Bid\1_PPGDtrend.txt', header = None, delim_whitespace = True)
Training_Data_Two = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\Bid\2_PPGDtrend.txt', header = None, delim_whitespace = True)
Training_Data_Three = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\Bid\3_PPGDtrend.txt', header = None, delim_whitespace = True)
Training_Data_Four = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\Bid\4_PPGDtrend.txt', header = None, delim_whitespace = True)
Training_Data_Five = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\Bid\5_PPGDtrend.txt', header = None, delim_whitespace = True)
Training_Data_Six = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\Bid\6_PPGDtrend.txt', header = None, delim_whitespace = True)
Training_Data_Seven = pd.read_csv(r'C:\Users\Robinson\Documents\MATLAB\Data\Bid\7_PPGDtrend.txt', header = None, delim_whitespace = True)
